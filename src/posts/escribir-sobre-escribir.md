---
id: escribir-sobre-escribir
uuid: 7486d88a-746a-4ed1-bc78-144cba26e79e
title: 'Escribir sobre escribir'
preview-image: $BASE_URL$/imgs/escribir-sobre-escribir/escribir-sobre-escribir.jpg
author: Nepo
category: life
date: 2026-01-12T00:00:00Z
last-update: 2026-01-12T11:00:00Z
abstract: Exploro la escritura y mi relación con ella a través de varios ensayos, videoensayos y obras que me han llegado recientemente.
...
En su ensayo ["Contra el algoritmo: cultivar ideas en vez de likes"](https://minishinternet.com/2025/10/18/contra-el-algoritmo-cultivar-ideas-en-vez-de-likes/), Alba Lafarga nos anima a crear un espacio propio para luchar contra la [mierdificación](https://es.wikipedia.org/wiki/Decadencia_de_plataformas) del Internet. Combatir el consumo instantáneo de la FYP y el tweet de "aquí te pillo, aquí te mando" con una comunicación más pausada y exploratoria.
...
>
> — Alba Lafarga (minishinternet.com), ["Contra el algoritmo: cultivar ideas en vez de likes"](https://minishinternet.com/2025/10/18/contra-el-algoritmo-cultivar-ideas-en-vez-de-likes/)
...
Seguramente conoces esa cita (falsamente atribuída a Einstein) que dice que "si no eres capaz de explicárselo a una criatura de 6 años, no lo entiendes". Y es que lo vemos en técnicas como el [rubber-duck debugging](https://es.wikipedia.org/wiki/M%C3%A9todo_de_depuraci%C3%B3n_del_patito_de_goma): explicar algo nos permite verlo desde perspectivas distintas y rellenar los huecos que faltan en nuestra comprensión. Cory Doctorow (que acuñó el término "enshitification" del que hablamos antes) escribe sobre escribir:

> It's revelatory. It teaches you what you know. It lets you know what you know. It lets you know _more_ than you know. It's alchemical. It creates new knowledge, and dispels superstition. It sharpens how you think. It sharpens how you talk. And obviously, it sharpens how you write.
> 
> — Cory Doctorow (pluralistic.net), ["Writing vs AI"](https://pluralistic.net/2026/01/07/delicious-pizza/)
...
[https://www.youtube.com/clip/UgkxWVSFIQZiXNaC4sgj5LpoZehPF_80F4yP](https://www.youtube.com/clip/UgkxWVSFIQZiXNaC4sgj5LpoZehPF_80F4yP)
...
>
> — @odysseas\_\_ (https://www.youtube.com/@odysseas__), ["I’m begging you to write essays"](https://www.youtube.com/watch?v=DO5MflX_eik)
...
Por suerte, encontré este video ensayo sobre escritura creativa de [@WritingwithAndrew](https://www.youtube.com/@WritingwithAndrew) que me abrió los ojos a otro tipo de escritura:
...
[https://www.youtube.com/clip/UgkxmziJH2h_UhuaFZdkATCfjMN1nWSQylnf](https://www.youtube.com/clip/UgkxmziJH2h_UhuaFZdkATCfjMN1nWSQylnf)
...
>
> — @WritingwithAndrew (https://www.youtube.com/@WritingwithAndrew), ["I'm Politely Begging You to Write Nonfiction"](https://www.youtube.com/watch?v=WIP_hLaLnLo)

Porque a veces *qué* se cuenta no es tan importante, válido, hermoso y valioso como el *cómo*. Me sirvió de ejemplo de este tipo de escritura descubrir a [Xot d'octubre](https://xotdoctubre.substack.com/), que escribe cosas preciosas y evocadoras en catalán, y conectar con Juarrín, de [La cueva de los ecos](https://lacuevadelosecos.es/).

Todo esto me ha despertado las ganas de escribir de nuevo, lo que ha resultado en este artículo que estás leyendo (¡gracias! ❤️) y en [un pequeño juego narrativo sobre finales y *burnout*](https://alicia-redmarr.itch.io/pedacitos).
